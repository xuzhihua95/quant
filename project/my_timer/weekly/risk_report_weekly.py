...
def risk_report_weekly():
    ...
    acc_mail_name = ['jie.dai@mfcteda.com', 'xin.liu@mfcteda.com',
                     'jing.yuan@mfcteda.com', 'ping.zhong@mfcteda.com']  # 抄送邮箱 list

    subject_header = "金融工程风险周报(2019年4月15日-4月19日)"  # 邮件标题
